    ...
    ui(new Ui::CTConfToyMickey)
{
    ...
    ui->qcb_force->addItems(QStringList() << "all" << "left" << "right" );
}

void CTConfToyMickey::on_qrb_null_event_toggled(bool checked)
{
    ui->tabFeedbackAction->setDisabled(checked);
}

CTConfToyMickey::~CTConfToyMickey()
{
    delete ui;
}

/*!
 * \brief CTConfToyMickey::setParameters
 *
 ...
 */
bool CTConfToyMickey::setParameters(QDomElement root)
{
    /* Check if the supplied configuration is applicable */
    if ("block" != root.tagName() || "mickey" != root.attribute("name"))
    {
        return false;
    }
 ...
 */
QString CTConfToyMickey::getParameters(QString value){
 ...
 */
QDomElement CTConfToyMickey::getParameters()
{
    QDomDocument doc;
    QDomElement root = doc.createElement("block");
    root.setAttribute("id", 1);
    root.setAttribute("name", "mickey");
 ...
 */
double CTConfToyMickey::calculateRequiredTime()
{
...
/*!
 * \brief CTConfToyMickey::updateBlockRuntime
 *
 ...
 */
void CTConfToyMickey::updateBlockRuntime(bool value)
{
    value = false;
 ...
 * \param value This parameter is unused.
 */
void CTConfToyMickey::updateBlockRuntime(double value)
{
    value = 0;
    ui->qsb_block_duration->setValue(calculateRequiredTime());
