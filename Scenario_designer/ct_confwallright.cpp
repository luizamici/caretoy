...
CTConfWallRight::CTConfWallRight(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CTConfWallRight)
{
    ui->setupUi(this);
...
CTConfWallRight::~CTConfWallRight()
{
    delete ui;
}
 ...
 */
bool CTConfWallRight::setParameters(QString xml)
{
 ...
 */
//bool CTConfWallRight::setParameters(QDomElement root)
//{
//    /* Check if the supplied configuration is applicable */
//    if ("block" != root.tagName() || "wall_right" != root.attribute("name"))
//    {
//        return false;
//    }
...
/*!
 * \brief CTConfWallRight::getParameters
 *
 ...
 */
QString CTConfWallRight::getParameters(QString value){
    ...
    stream.writeAttribute("name", "wall_right");
 ...
 */
//QDomElement CTConfWallRight::getParameters()
//{
//    QDomDocument doc;
//    QDomElement root = doc.createElement("block");
//    root.setAttribute("id", 1);
//    root.setAttribute("name", "wall_right");
...
/*!
 * \brief CTConfWallRight::calculateRequiredTime
 *
 ...
 */
double CTConfWallRight::calculateRequiredTime()
{
...
/*!
 * \brief CTConfWallRight::updateBlockRuntime
 *
 ...
 */
void CTConfWallRight::updateBlockRuntime(bool value)
{
    value = false;
 ...
 * \param value This parameter is unused.
 */
void CTConfWallRight::updateBlockRuntime(double value)
{
    value = 0;
    ui->qsb_block_duration->setValue(calculateRequiredTime());
...
void CTConfWallRight::on_qrb_null_event_toggled(bool checked)
{
