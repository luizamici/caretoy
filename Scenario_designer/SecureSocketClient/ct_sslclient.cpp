#include "ct_sslclient.h"

#define CT_CHUNK 512

CTSslClient::CTSslClient(QObject *parent) :
    QObject(parent)
{
...
void CTSslClient::socketStateChanged(QAbstractSocket::SocketState state)
{
...
void CTSslClient::socketEncrypted()
{
...
void CTSslClient::sslErrors(const QList<QSslError> &errors)
{
...
void CTSslClient::socketReadyRead()
{
    QByteArray payload;
...
void CTSslClient::connectedToHost()
{
...
bool CTSslClient::requestForWrite(const QString &parsedQuery)
{
    QByteArray out;
