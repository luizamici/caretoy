...
/*!
    ...
    read correctly.
    True is returned to indicate that parsing should continue.
*/
...
/*!
  Parse characters in the xml of the scenario.
  Use the values for setting the input fields of each configuration block.
  True is returned to indicate that parsing should continue.
*/
