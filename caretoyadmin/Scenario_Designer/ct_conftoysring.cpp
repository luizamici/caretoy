...
#include "ui_ct_conftoysring.h"
#include "ct_xmlhandler.h"

#define NUM_LIGHTS 1
#define NUM_SPEAKERS 1

CTConfToySRing::CTConfToySRing(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CTConfToySRing)
{
    ui->setupUi(this);
 ...
 */
bool CTConfToySRing::setParameters(QString xml)
{
...
/*!
 * \brief CTConfToySRing::getParameters
 *
 ...
 */
QString CTConfToySRing::getParameters(QString value){
    ...
    stream.writeAttribute("name", "small_ring");
...
/*!
 * \brief CTConfToySRing::calculateRequiredTime
 *
 ...
 */
double CTConfToySRing::calculateRequiredTime()
{
...
/*!
 * \brief CTConfToySRing::updateBlockRuntime
 *
 ...
 */
void CTConfToySRing::updateBlockRuntime(bool value)
{
    value = false;
 ...
 * \param value This parameter is unused.
 */
void CTConfToySRing::updateBlockRuntime(double value)
{
    value = 0;
    ui->qsb_block_duration->setValue(calculateRequiredTime());
...
void CTConfToySRing::on_qrb_null_event_toggled(bool checked)
{
